        ...
        <c:forEach var="i" items="${AllEvents}" varStatus="count">
            <tr>
                ...
                <td style="text-align: left;">
                    <div align="left" style="text-align: left;">${count.count}</div>
                </td>
                <td>${i.eventName}</td>
                <td>${i.eventDate}</td>
                <td>${i.eventTime}</td>
    ...
    <tr>
        <td colspan="2" style="text-align: center;">
            ...
            <strong style="color: black; ">Registration form [<a
                    href="http://www.westchestertabletennis.com/pics/pdf/Westchester2013Sep.pdf">pdf</a>]</strong>
...
<table class="smallprinttable">
    ...
    <tr>
        <td>
            ...
            <p class="smallprint"><strong>Referee/Rank: </strong>Roman Tinyszin/IR</p>

            <p class="smallprint"><strong>Equipment: </strong>USATT-approved equipment - Double Happiness tables &amp;
                nets; white JOOLA Premium 3-star 40 mm balls. Gymnasium floor: wood</p>
